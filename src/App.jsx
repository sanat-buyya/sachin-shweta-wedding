...
export default function Hero() {
  ...
  // May 2026 starts on Friday → add empty slots
  const startOffset = 5;
  const totalDays = 31;
  ...
  useEffect(() => {
    // Set wedding date: May 11, 2026 (adjust time as needed)
    const weddingDate = new Date(2026, 4, 11, 11, 39, 0); // Month is 0-indexed (4 = May)
      ...
      >
        ...
        <div className="">
          <img
            src={Flower}
            alt="floral"
            className="top-0 right-0 w-full h-32 opacity-90 rotate-180 mb-4"
          />
          ...
          {/* Save the date with animation calendar 11 may 2026 date circle */}
          <div className="flex justify-center">
  <motion.div
    initial={{ opacity: 0, y: 40, rotateX: -20 }}
    whileInView={{ opacity: 1, y: 0, rotateX: 0 }}
    transition={{ duration: 0.8, type: "spring" }}
    className="rounded-2xl w-80 relative overflow-hidden"
    style={{
      backgroundImage:
        "url('https://res.cloudinary.com/dgrxmavho/image/upload/v1776146836/Picsart_26-04-14_11-36-46-318_fqrkfh.png')",
      ...
      >
        Time: 11:39 AM
          ...
          <iframe
            ...
            className="w-full h-48 rounded-2xl border-0 px-2"
            style={{ border: 0 }}
            loading="lazy"
          ...
          <motion.img
            src={Flower}
            alt="floral"
            className="bottom-0 right-0 w-full h-32 opacity-90"
